    ...
    <div class="row">
        <div class="col-md-11">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Use</div>
                  ...
                  <div class="col-lg-12">
                    <div class="panel panel-green">
                      <div class="panel-body pan">
                        <form class="form-horizontal" method="POST" action="{{ url('use/update') }}" enctype="multipart/form-data">
                         {{ csrf_field() }}
                          ...
                          <div class="form-actions">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                &nbsp;
                                <a href="{{url('/use/list')}}"  type="button" class="btn btn-primary">Cancel</a>
                            </div>
                          </div>
                        </form>
                      </div>
