    ...
    <div class="row">
        <div class="col-md-11">
            <div class="panel panel-default">
                <div class="panel-heading">Add Usage</div>
                  ...
                  <div class="col-lg-12">
                    <div class="panel panel-green">
                      <div class="panel-body pan">
                       <form class="form-horizontal" method="POST" action="{{ url('use/store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <div style="float: left; margin-right:3px;">
                                  <a href="{{ url('use/list') }}" title="Back" class="btn btn-primary">Back</a>  
                                </div>
                            </div>
                        </div>
                    </form>
